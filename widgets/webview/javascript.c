/*
 * widgets/webview/javascript.c - webview javascript extension
 *
...
static void
javascript_extension_destructor(webview_extension_t *e, webview_data_t *wd)
{
    (void) wd;
...
static int
javascript_extension_index(webview_extension_t *e, webview_data_t *d, lua_State *L, luakit_token_t t)
{
    (void) e;
    (void) d;
...
/**
 * Creates a new javascript extension that handles webframe events and makes them
 * available to Lua.
 */
webview_extension_t *
javascript_extension_new(webview_data_t *wd)
{
    (void) wd;

    webview_extension_t *e = g_slice_new(webview_extension_t);
    e->destructor = javascript_extension_destructor;
    e->index = javascript_extension_index;
    e->newindex = NULL;
    e->data = NULL;
    return e;
}
